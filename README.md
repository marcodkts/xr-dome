...
VITURE_LOG_IMU=1
VITURE_TRACE_TRACKING=1
VITURE_ORIENTATION_FORMAT=raw12
...
Para calibração fina do tracking:

```bash
VITURE_YAW_OFFSET_DEGREES=0
VITURE_PITCH_OFFSET_DEGREES=0
VITURE_ROLL_OFFSET_DEGREES=0
VITURE_AUTO_CENTER_ON_START=1
```
